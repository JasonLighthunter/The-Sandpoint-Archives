...
defined('EXIT__AUTO_MIN')      OR define('EXIT__AUTO_MIN', 9); // lowest auto-assigned error code
defined('EXIT__AUTO_MAX')      OR define('EXIT__AUTO_MAX', 125); // highest auto-assigned error code
